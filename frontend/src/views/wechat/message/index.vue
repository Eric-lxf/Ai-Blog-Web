  ...
  <div class="app-container">
    <el-form :inline="true" :model="queryParams" class="mb8">
      ...
      <el-form-item label="关键词">
        <el-input v-model="queryParams.keyword" placeholder="OpenID/内容关键词" clearable style="width: 220px" @keyup.enter="handleQuery" />
      </el-form-item>
      <el-form-item>
    ...
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="消息类型" prop="messageType" width="110" />
      <el-table-column label="事件类型" prop="eventType" width="120" show-overflow-tooltip />
