...
- [x] **Step 1: 实体与 CRUD 树**（对齐 `MallCategoryServiceImpl`）

- [x] **Step 2: rel 替换与 resolveBackCategoryIds**
...
- [x] **Step 3: Controller `/mall/front-category`**
...
- [x] **Step 4: Public categories API**
...
- [x] **Step 1: API 封装**（对齐 `category.js`/`brand.js`）
...
- [x] **Step 5: Compile backend + Commit**
