...
(2050, ${q(T.menuRoot)}, 0, 7, 'wechat-admin', NULL, '', 'WechatAdmin', 1, 0, 'M', '0', '0', '', 'wechat', 'admin', sysdate(), '', NULL, ${q(T.menuRootRemark)}),
(2051, ${q(T.menuAccount)}, 2050, 1, 'account', 'wechat/account/index', '', 'WechatAccount', 1, 0, 'C', '0', '0', 'wechat:account:list', 'user', 'admin', sysdate(), '', NULL, ''),
(2052, ${q(T.menuPublish)}, 2050, 2, 'publish', 'wechat/publish/index', '', 'WechatPublish', 1, 0, 'C', '0', '0', 'wechat:publish:list', 'message', 'admin', sysdate(), '', NULL, ''),
(2053, ${q(T.menuMaterial)}, 2050, 3, 'material', 'wechat/material/index', '', 'WechatMaterial', 1, 0, 'C', '0', '0', 'wechat:material:list', 'documentation', 'admin', sysdate(), '', NULL, ''),
(2054, ${q(T.menuMenu)}, 2050, 4, 'wx-menu', 'wechat/menu/index', '', 'WechatMenu', 1, 0, 'C', '0', '0', 'wechat:menu:list', 'tree', 'admin', sysdate(), '', NULL, ''),
(2055, ${q(T.menuReply)}, 2050, 5, 'reply', 'wechat/reply/index', '', 'WechatReply', 1, 0, 'C', '0', '0', 'wechat:reply:list', 'edit', 'admin', sysdate(), '', NULL, ''),
(2056, ${q(T.menuFans)}, 2050, 6, 'fans', 'wechat/fans/index', '', 'WechatFans', 1, 0, 'C', '0', '0', 'wechat:fans:list', 'peoples', 'admin', sysdate(), '', NULL, ''),
(2057, ${q(T.menuMessage)}, 2050, 7, 'message-log', 'wechat/message/index', '', 'WechatMessageLog', 1, 0, 'C', '0', '0', 'wechat:message:list', 'form', 'admin', sysdate(), '', NULL, ''),
