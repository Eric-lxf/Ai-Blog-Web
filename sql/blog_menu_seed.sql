...
(2104, '图片上传', 2000, 6, '#', '', '', '', 1, 0, 'F', '0', '0', 'blog:upload:image', '#', 'admin', sysdate(), '', NULL, ''),
(2105, 'AI对话', 2000, 7, '#', '', '', '', 1, 0, 'F', '0', '0', 'blog:ai:chat', '#', 'admin', sysdate(), '', NULL, '');
...
(3, 2000), (3, 2001), (3, 2002), (3, 2005),
(3, 2100), (3, 2101), (3, 2102), (3, 2104), (3, 2105);
