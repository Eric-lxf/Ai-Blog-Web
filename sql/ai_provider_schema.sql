...
CREATE TABLE IF NOT EXISTS `ai_provider` (
  ...
  `auth_mode` varchar(32) NOT NULL DEFAULT 'api_key' COMMENT 'api_key(x-api-key) | auth_token(Bearer/ANTHROPIC_AUTH_TOKEN)',
  `api_key` varchar(512) NOT NULL COMMENT 'API Key 或 Auth Token',
