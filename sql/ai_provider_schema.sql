...
CREATE TABLE IF NOT EXISTS `ai_provider` (
  ...
  `api_key` varchar(512) NOT NULL COMMENT 'API Key 或 Anthropic Auth Token',
  `auth_mode` varchar(32) NOT NULL DEFAULT 'api_key' COMMENT 'api_key | auth_token，仅 Anthropic 使用',
